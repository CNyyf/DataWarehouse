...
<<<<<<< HEAD
       ...
       $('[data-ride="datatables"]').each(function () {
            var oTable = $(this).dataTable({
                ...
                "aoColumns": [{Data: 'Product Id'}, {Data: 'Movie Name'}, {Data: 'Posted Tim'}, {Data: 'version'}],
                "fnServerData" : function(sSource, aoData, fnCallback){  $("#dataRows").empty();
                    $.ajax({
                        dataType : "json",
                        type : "get",
                        url : sSource,
