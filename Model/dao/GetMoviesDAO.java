...
public class GetMoviesDAO {
	...
	public int getMoviesByRand(ArrayList<Long> timeCountList, ArrayList<DbMovieDimension> movieList, String in_moviename, String in_year, String in_month, String in_day, String in_season, String in_dayofweek, String in_typename, String in_directorname, String in_starname, String in_actorname) {
		int message = FAILED;
		try {
			dbconn = new DatabaseConnection();
			conn = dbconn.getConnection();
			String sql = "call dwmovie.get_movies_by_rand(?,?,?,?,?,?,?,?,?,?,?)";
